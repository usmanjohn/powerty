...
def convert_to_ckeditor(apps, schema_editor):
    PracitceQuestions = apps.get_model('practice', 'PracitceQuestions')
    for question in PracitceQuestions.objects.all():
...
class Migration(migrations.Migration):
    dependencies = [
        ("practice", "0002_practice_category_alter_pracitcequestions_image"),
    ]
